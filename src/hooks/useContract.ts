...
import useGovStake from "../graphql/queries/useBankBalances"
...
export const useContractState = (address: string): Contract => {
  ...
  const result: Result = {
    ...
    // [GOVStakedKey.STAKEDLOOP]: staked,
  }
  ...
  const data = {
    ...
    /*[GOVStakedKey.STAKEDLOOP]:
    govStaked[GOVStakedKey.STAKEDLOOP](staked.data),*/
  }
  ...
  // const stakedLoop = data[GOVStakedKey.STAKEDLOOP]
